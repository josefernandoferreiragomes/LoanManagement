...
namespace LoanManagement.WebSite.Repository
{
    public class ApiLoanRepository : IApiLoanRepository
    {

        public async Task<List<Management.Customer>> ObtainCustomers()
        {
        ...
        public async Task<List<Management.CustomerLoanInstallmentDBOutItem>> ObtainLoanInstallmentPage(int CustomerId, int pageSize, int LastPageLastItemId)
        {
